...
Create a new Compose definition `docker-compose.yml` using this [configuration file](https://github.com/docker/labs/blob/master/developer-tools/java/chapters/ch05-compose.adoc#configuration-file).
